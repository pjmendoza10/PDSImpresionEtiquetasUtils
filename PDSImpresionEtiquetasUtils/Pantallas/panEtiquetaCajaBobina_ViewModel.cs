...
{
    public class panEtiquetaCajaBobina_ViewModel : panPantallaBase_ViewModel
    {     

        public panEtiquetaCajaBobina_ViewModel()
        {
        ...
        internal override void Inicializa()
        {
            ...
            Gen.NombreCliente = "Cliente General";
        ...
        */
        ...
        public void VerPantallaEtiqueta_Command_Execute()
        {
            ...
            if (ListaClientesEtiquetas_SelectedItem != null)
            {
                ...
                if (ListaClientesEtiquetas_SelectedItem.Id == 02) b_pantalla = new Pantallas.panImpresionEtiquetaCOliveRueda();
            ...
            if (Utilidades.UtilesCarga._pantallas_abiertas.Any(z => z.Key == b_pantalla.ToString()))
            {
                ...
                if (ListaClientesEtiquetas_SelectedItem.Id == 02) b_pantalla = (Pantallas.panImpresionEtiquetaCOliveRueda)Utilidades.UtilesCarga._pantallas_abiertas.FirstOrDefault(z => z.Key == b_pantalla.ToString()).Value;
